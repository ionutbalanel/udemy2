...
public class Car {
    ...
    public Car(String brand, String model, Engine engine, Tire tire1, Tire tire2, Tire tire3, Tire tire4, Tire exchangeTire) {
        ...
        if (tire1.size != givenSize || tire2.size != givenSize || tire3.size != givenSize || tire4.size != givenSize || exchangeTire.size != givenSize){
            System.out.println("Nu toate cauciucurile au aceeasi marime.");
        }
            this.brand = brand;
        this.model = model;
        this.engine = engine;
